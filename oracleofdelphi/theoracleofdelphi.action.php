 ...
 * -----
 * 
 * theoracleofdelphi.action.php
 *
 * TheOracleOfDelphi main action entry point
 *
 *
 ...
 */
  ...
  class action_theoracleofdelphi extends APP_GameAction
  { 
    // Constructor: please do not modify
   	public function __default()
  	{
  	    ...
  	    {
            $this->view = "theoracleofdelphi_theoracleofdelphi";
